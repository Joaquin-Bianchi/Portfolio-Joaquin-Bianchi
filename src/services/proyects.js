const proyects = [
  {
    ProjectName: "Comfy Furnite Store",
    Description:
      "COMFY es un E-commerce de muebles, forma parte de las emulaciones laborales de No Country, se ha desarrollado en grupo con otros desarroladores y diseñadores, utilizando tecnologías como Next js, React Taiwind  entre otras",
    Imagen: "assets/comfy2.png",
    Tags: "",
    LinkRepo: "https://github.com/Joaquin-Bianchi/Comfy-Ecommerce",
