...
function ProjectCard({
  ...
  return (
    <div className="p-3 md:w-[31%] xl:w[30%] sm:mb-0 mb-6 bg-white border-1 dark:text-white dark:bg-[#201e31 dark:bg-zinc-800 border-[1px] border-zinc-500  dark:border-[#bdbcbcba] flex flex-col  justify-between drop-shadow-xl">
